...
namespace DevGoose
{
    class Main : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (Input.GetKey(KeyCode.LeftControl) && Input.GetKeyDown(KeyCode.T) || (Input.GetKey(KeyCode.JoystickButton4) && Input.GetKey(KeyCode.JoystickButton5) && Input.GetKeyDown(KeyCode.JoystickButton2)))
            {
                this._bell.transform.position = this._goose.transform.position;
            }
            if (Input.GetKey(KeyCode.LeftControl) && Input.GetKeyDown(KeyCode.H) || (Input.GetKey(KeyCode.JoystickButton4) && Input.GetKey(KeyCode.JoystickButton5) && Input.GetKeyDown(KeyCode.JoystickButton2)))
            {
                this._boot.transform.position = this._goose.transform.position;
            }
            if (Input.GetKey(KeyCode.LeftControl) && Input.GetKeyDown(KeyCode.B) || (Input.GetKey(KeyCode.JoystickButton4) && Input.GetKey(KeyCode.JoystickButton5) && Input.GetKeyDown(KeyCode.JoystickButton2)))
            {
