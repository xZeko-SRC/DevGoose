...
namespace DevGoose
{
    class Main : MonoBehaviour
    {
        ...
        public bool _advancedOutput, _noclip, _menuEnabled;
        ...
        void Update()
        {
            ...
            {
                _goose.transform.position = _bell.transform.position;
            }
        ...
        {
            Vector3[] bellPosition = new[]
           {
                new Vector3 (Random.Range(-52.1f,-38.8f), Random.Range(0.5f,2.0f),Random.Range(12.5f,-1.6f)), // Mini Village
				//new Vector3 (Random.Range(-55.9f,-52.0f), Random.Range(1.5f,2f),Random.Range(1.1f,1.1f)), // 
				new Vector3 (Random.Range(-37.7f,-2.5f), Random.Range(2.0f,3.0f),Random.Range(10.2f,-2.5f)), // Pink Area
				new Vector3 (Random.Range(-13.5f,22.8f), Random.Range(2.0f,3.0f),Random.Range(21.7f,10.8f)), // BackGardens
				new Vector3 (Random.Range(-1.9f,22.8f), Random.Range(1.2f,2.0f),Random.Range(0.9f,10.8f)), // High Street
				new Vector3 (Random.Range(13.8f,37.2f), Random.Range(1.2f,2.0f),Random.Range(-8.6f,-14.2f)), // Gardens
                new Vector3 (Random.Range(-14.1f,1.5f), Random.Range(1.2f,2.0f),Random.Range(-3.1f,-18.3f)) // Gardens
			};

            for (int i = 0; i < bellPosition.Length; i++)
            {
                _bell = GameObject.Find("goldenBell");
                Vector3 randomlyChosenCoordinate = bellPosition[Random.Range(0, bellPosition.Length)];
                _bell.transform.position = randomlyChosenCoordinate;
            }
        }
        public void OnGUI()
        {
